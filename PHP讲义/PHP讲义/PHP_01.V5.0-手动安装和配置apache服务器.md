...
- **以管理员身份**打开**命令行**，然后输入以下命令：
  ...
  ![01_安装Apache服务成功](media/01_安装Apache服务成功.png)
...
- 点击右键，选择**以管理员身份运行**，如下图所示：
  ...
  ![02_找到并启动Apache监视器](media/02_找到并启动Apache监视器.png)

- 可以在**任务栏的通知区域**看到 **Apache 服务监视器**图标，如下图所示：

  ![03_任务栏的Apache监视器](media/03_任务栏的Apache监视器.png)

- 双击此图标，可以看到如下 **Apache 服务监视器**窗口：

  ![04_Apache监视器窗口](media/04_Apache监视器窗口.png)
...
- 点击 **Apache 服务监视器**中的 **start** 按钮启动 Apache 服务，如果配置正确，可以看到如下窗口：
  ...
  ![05_启动服务的监视器窗口](media/05_启动服务的监视器窗口.png)
...
3. 打开浏览器，在地址栏输入 `127.0.0.1`，然后按照下图操作：
   ...
   ![06_测试Apache+php](media/06_测试Apache+php.png)
